...
# SECURITY
# --------------------------------------------------------------------------
SECRET_KEY = config('SECRET_KEY', default='django-insecure-CHANGE-THIS-SECRET-KEY-BEFORE-DEPLOYING')
...
# --------------------------------------------------------------------------
# DATABASE  ---  >>> CHANGE YOUR MYSQL USERNAME & PASSWORD HERE <<<
# --------------------------------------------------------------------------
# Replace the values of 'USER' and 'PASSWORD' below with your own MySQL
# credentials. Also make sure a database named 'codeplatform_db' exists in
# your MySQL server (or change 'NAME' to match an existing database).
#
#   mysql -u root -p
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='codeplatform_db'),
        'USER': config('DB_USER', default='root'),
        'PASSWORD': config('DB_PASSWORD', default='Shrinidhi@123'),
